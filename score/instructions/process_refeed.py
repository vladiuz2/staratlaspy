...
class ProcessRefeedArgs(typing.TypedDict):
    staking_bump: int
    scorevars_bump: int
...
layout = borsh.CStruct(
    ...
    "food_quantity" / borsh.U64,
)


class ProcessRefeedAccounts(typing.TypedDict):
    ...
    ship_mint: PublicKey
    food_mint: PublicKey
    food_token_account_source: PublicKey
    food_token_account_escrow: PublicKey


def process_refeed(
    args: ProcessRefeedArgs, accounts: ProcessRefeedAccounts
    ...
    keys: list[AccountMeta] = [
        ...
        AccountMeta(
            pubkey=accounts["food_token_account_source"],
            is_signer=False,
            is_writable=True,
        ),
        AccountMeta(
    ...
    identifier = b"\xdd\xef\xf9\x15?S\xec\x80"
    encoded_args = layout.build(
        {
            ...
            "food_quantity": args["food_quantity"],
        }
    )
