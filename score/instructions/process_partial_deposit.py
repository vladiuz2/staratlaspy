...
class ProcessPartialDepositArgs(typing.TypedDict):
    staking_bump: int
...
class ProcessPartialDepositAccounts(typing.TypedDict):
...
def process_partial_deposit(
    args: ProcessPartialDepositArgs, accounts: ProcessPartialDepositAccounts
    ...
    identifier = b"4\xc3\x9c\x14SI\x1e\x15"
